        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              <img src="/logo/wp-logo-white.png" alt="Wrocław Południe" className="h-24 w-auto" />
            </div>
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-4 pt-2">
                <motion.a
                  href="https://www.facebook.com/Wroclaw.Poludnie"
                  target="_blank"
                ...
                <motion.a
                  href="https://www.instagram.com/wroclaw_poludnie/"
                  target="_blank"
                  rel="noopener noreferrer"
                  whileHover={{ scale: 1.2 }}
                  className="text-foreground/70 hover:text-accent transition-colors duration-300"
